...
export default function Footer() {
  return (
    ...
    <div className="absolute w-[1920px] h-[418px] ">
      ...
      <div className="absolute w-[1920px] h-[343px] flex flex-row justify-between px-[300px] py-[80px] border-2">
        ...
        <div className="absolute flex flex-col items-start gap-5 w-[105px] h-[203px] ml-[440px]">
          ...
          <div className="flex flex-col items-start gap-3 w-[105px] h-[168px]">
            {/* <!-- Sofa --> */}
            <div className="text-[#272343] font-inter font-normal text-[16px] leading-[110%] w-[35px] h-[18px] hover:text-[#007580] hover:underline">
              Sofa
            </div>

            {/* <!-- Armchair --> */}
            <div className="text-[#272343] font-inter font-normal text-[16px] leading-[110%] w-[68px] h-[18px] hover:text-[#007580] hover:underline">
              Armchair
            </div>

            {/* <!-- Wing Chair --> */}
            <div className="text-[#272343] font-normal text-[16px] leading-[110%] w-[83px] h-[18px] hover:text-[#007580] hover:underline">
              Wing Chair
            </div>

            {/* <!-- Desk Chair --> */}
            <div className="text-[#272343] font-inter font-normal text-[16px] leading-[110%] w-[83px] h-[18px] hover:text-[#007580] hover:underline">
              Desk Chair
            </div>

            {/* <!-- Wooden Chair --> */}
            <div className="text-[#272343] font-inter font-normal text-[16px] leading-[110%] w-[105px] h-[18px] hover:text-[#007580] hover:underline">
              Wooden Chair
            </div>

            {/* <!-- Park Bench --> */}
            <div className="text-[#272343] font-inter font-normal text-[16px] leading-[110%] w-[86px] h-[18px] hover:text-[#007580] hover:underline">
              Park Bench
            </div>
          </div>
        </div>
        ...
        <div className="absolute  ml-[640px] flex flex-col items-start gap-5">
          ...
          <div className="flex flex-col items-start gap-3 w-[156px] h-[108px]">
            {/* <!-- Help & Support --> */}
            <div className="text-[16px] font-normal leading-[110%] text-[#272343] w-[115px] h-[18px] hover:text-[#007580] hover:underline">
              Help & Support
            </div>
            {/* <!-- Terms & Conditions --> */}
            <div className="text-[16px] font-normal leading-[110%] text-[#272343] w-[156px] h-[18px] hover:text-[#007580] hover:underline">
              Terms & Conditions
            </div>
            {/* <!-- Privacy Policy --> */}
            <div className="text-[16px] font-normal leading-[110%] text-[#272343] w-[105px] h-[18px] hover:text-[#007580] hover:underline">
              Privacy Policy
            </div>
            {/* <!-- Help --> */}
            <div className="text-[16px] font-normal leading-[110%] text-[#272343] w-[35px] h-[18px] hover:text-[#007580] hover:underline">
              Help
            </div>
          </div>
        </div>
